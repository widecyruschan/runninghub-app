...
ENV CREEM_API_KEY=creem_test_6bJGOF97qFn3jTWIYxhGL3
ENV CREEM_WEBHOOK_SECRET=whsec_43xCaU1JLn5PM2n5PDbu5k
ENV CREEM_API_BASE_URL=https://test-api.creem.io/v1
